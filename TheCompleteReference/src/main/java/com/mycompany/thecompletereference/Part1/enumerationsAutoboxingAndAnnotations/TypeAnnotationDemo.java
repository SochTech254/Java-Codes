...
class TypeAnnotationDemo<@What1(description = "Generic data type") T> {
    ...
    public int f(@TypeAnno TypeAnnotationDemo<T> this, int x) {
        return 10;
    }
    ...
    // Use atype annotation with a throws clause.
    ...
    public static void myMeth(int i) {
        ...
        TypeAnnotationDemo<@TypeAnno Integer> ob = new TypeAnnotationDemo<@TypeAnno Integer>();

        // Use a type annotation with new.
        @Unique TypeAnnotationDemo<Integer> ob2 = new @Unique TypeAnnotationDemo<Integer>();
    ...
    class SomeClass extends @TypeAnno TypeAnnotationDemo<Boolean> { }
}
